...
SERVICE_PROCESS_CENTRIC_DB_PORT = 80
SERVICE_PROCESS_CENTRIC_DB_HOST = 'localhost'

SERVICE_BUSINESS_LOGIC_DB = 'business_logic_db_layer'
SERVICE_BUSINESS_LOGIC_DB_PORT = 80
SERVICE_BUSINESS_LOGIC_DB_HOST = 'localhost'

SERVICE_UTILITY = 'query_selection'
SERVICE_UTILITY_PORT = 80
SERVICE_UTILITY_HOST = 'travelando-utility.herokuapp.com'
